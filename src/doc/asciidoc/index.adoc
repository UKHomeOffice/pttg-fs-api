...
This API can be used to:
 ...
 . Calculate the minimum balance requirement for a Tier 4 application
 . Check whether an individual meets the <<Financial Status>> requirements for a Tier 4 application by consulting the
...
code, account number, aand date of birth must precisely match the account record at Barclays. The daily closing balances
