...
public class ThresholdCalculatorTier2 {

    public static final String BASEPATH = "/pttg/financialstatus/v1/t2";
    ...
    @Test
    public void thresholdCalculationTier2() throws Exception {
