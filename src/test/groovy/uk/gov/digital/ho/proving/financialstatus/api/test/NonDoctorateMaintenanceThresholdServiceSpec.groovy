...
class NonDoctorateMaintenanceThresholdServiceSpec extends Specification {
    ...
    def "Tier 4 Non Doctorate - Check 'All variants'"() {
        ...
        where:
        courseStartDate            | courseEndDate              | originalCourseStartDate    | inLondon | tuitionFees | tuitionFeesPaid | accommodationFeesPaid | dependants | courseType || threshold || feesCapped || courseCapped
        LocalDate.of(2016, 5, 23)  | LocalDate.of(2016, 7, 16)  | null                       | false    | 1202.93     | 8524.70         | 459.76                | 0          | "pre-sessional"      || 1570.24   || 0.00       || 0
        ...
        LocalDate.of(2022, 6, 3)   | LocalDate.of(2023, 3, 7)   | null                       | false    | 5078.11     | 7002.48         | 813.95                | 9          | "pre-sessional"      || 63401.05  || 0.00       || 9
        ...
        LocalDate.of(2020, 4, 22)  | LocalDate.of(2020, 7, 6)   | null                       | true     | 4203.55     | 7454.66         | 1995.55               | 0          | "pre-sessional"      || 2530.00   || 1265.00    || 0
        ...
        LocalDate.of(2051, 12, 23) | LocalDate.of(2052, 11, 7)  | null                       | false    | 4643.63     | 7510.33         | 425.94                | 14         | "pre-sessional"      || 94389.06  || 0.00       || 9
        ...
        LocalDate.of(1975, 10, 12) | LocalDate.of(1976, 4, 28)  | null                       | true     | 4185.34     | 3673.35         | 1127.70               | 13         | "pre-sessional"      || 107104.29 || 0.00       || 0
        ...
        LocalDate.of(1973, 12, 12) | LocalDate.of(1974, 8, 6)   | null                       | true     | 2274.30     | 9034.58         | 483.78                | 11         | "pre-sessional"      || 93291.22  || 0.00       || 0
        ...
        LocalDate.of(1975, 6, 21)  | LocalDate.of(1976, 4, 6)   | null                       | false    | 5146.43     | 3295.64         | 1820.98               | 4          | "pre-sessional"      || 34200.79  || 1265.00    || 9
        LocalDate.of(2005, 3, 1)   | LocalDate.of(2005, 6, 21)  | null                       | true     | 7826.07     | 7232.60         | 1450.09               | 0          | "pre-sessional"      || 4388.47   || 1265.00    || 0
        LocalDate.of(2006, 11, 18) | LocalDate.of(2007, 11, 17) | null                       | true     | 1481.30     | 8921.47         | 1571.84               | 10         | "MAIN"     || 86170.00  || 1265.00    || 9
        LocalDate.of(1978, 8, 3)   | LocalDate.of(1979, 6, 24)  | null                       | false    | 7915.21     | 1655.20         | 322.88                | 7          | "pre-sessional"      || 57912.13  || 0.00       || 9
        LocalDate.of(2013, 5, 1)   | LocalDate.of(2013, 5, 17)  | null                       | false    | 846.71      | 4200.54         | 1046.32               | 0          | "pre-sessional"      || 0.00      || 0.00       || 0
        LocalDate.of(2005, 11, 15) | LocalDate.of(2006, 6, 5)   | null                       | false    | 6379.37     | 5625.59         | 74.54                 | 4          | "pre-sessional"      || 32264.24  || 0.00       || 0
        LocalDate.of(2025, 10, 9)  | LocalDate.of(2026, 4, 3)   | LocalDate.of(2025, 6, 2)   | true     | 6369.19     | 3672.01         | 351.61                | 12         | "MAIN"     || 91055.57  || 0.00       || 0
        LocalDate.of(2037, 6, 28)  | LocalDate.of(2038, 6, 11)  | null                       | true     | 4256.02     | 1088.19         | 1143.76               | 14         | "pre-sessional"      || 119879.07 || 0.00       || 9
        ...
        LocalDate.of(2042, 2, 8)   | LocalDate.of(2043, 1, 19)  | null                       | true     | 2858.06     | 8068.43         | 341.54                | 2          | "pre-sessional"      || 26253.46  || 0.00       || 9
        ...
        LocalDate.of(1987, 6, 15)  | LocalDate.of(1987, 8, 25)  | null                       | false    | 6183.25     | 4344.86         | 1893.46               | 0          | "pre-sessional"      || 3618.39   || 1265.00    || 0
        ...
        LocalDate.of(1997, 8, 25)  | LocalDate.of(1997, 8, 31)  | null                       | false    | 1733.82     | 5717.65         | 221.02                | 0          | "pre-sessional"      || 793.98    || 0.00       || 0
        ...
        LocalDate.of(2015, 11, 15) | LocalDate.of(2016, 5, 3)   | null                       | true     | 5447.13     | 2820.30         | 852.07                | 0          | "pre-sessional"      || 9364.76   || 0.00       || 0
        ...
        LocalDate.of(2047, 8, 10)  | LocalDate.of(2047, 12, 5)  | null                       | true     | 3573.31     | 4583.26         | 74.20                 | 0          | "pre-sessional"      || 4985.80   || 0.00       || 0
