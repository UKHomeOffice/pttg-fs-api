...
case class AccountDailyBalanceCheck(fromDate: LocalDate, toDate: LocalDate, minimum: BigDecimal, pass: Boolean,  @JsonInclude(Include.NON_NULL) dateFundsNotMet: LocalDate,  @JsonInclude(Include.NON_NULL) amount: BigDecimal){
